...
class LoggerTest extends TestCase
{
    ...
    public function testLogsAtAllLevels($level, $message)
    {
        ...
        $expected = [
            "[$levelUpper] message of level $level with context: Bob",
            "[$levelUpper] message of level $level with context: Bob",
        ];
    ...
    {
        $this->logger = new Logger($this->tmpFile, LogLevel::INFO);
    ...
    {
        $this->logger->log('Foo', 'invalid level');
    }
    ...
    {
        $this->logger = new Logger($this->tmpFile, LogLevel::DEBUG, function ($level, $message, $context) {
